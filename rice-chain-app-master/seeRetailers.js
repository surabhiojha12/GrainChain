function seeRetailers(){
    let url = "http://localhost:3000/api/queries/selectRetailersParticipant"
    axios.get(url)
    .then((response) => {
    ...
    displayRetailers(response.data);
  });
}
...
function displayRetailers(data){
    ...
    for(producer in data){
        ...
        "<h2><strong>Retailer Id </strong>" + field.traderId +"</h2>" +
...
if(id== -1){
document.getElementById("display-retailers").innerHTML = htmlData;}
else{
